...
#             nn.ConvTranspose2d(in_channels=256, out_channels=32, kernel_size=self.k3, stride=self.s3,
#                                padding=self.pd3),
...
#         # # Decoder
#         # self.convTrans6 = nn.Sequential(
#         #     nn.ConvTranspose2d(in_channels=512, out_channels=256, kernel_size=2, stride=self.s4),
#         #     nn.BatchNorm2d(256, momentum=0.01),
#         #     nn.ReLU(inplace=True),
#         # )
#         # self.convTrans7 = nn.Sequential(
#         #     nn.ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=2, stride=self.s3),
#         #     nn.BatchNorm2d(128, momentum=0.01),
#         #     nn.ReLU(inplace=True),
#         # )
#         #
#         # self.convTrans8 = nn.Sequential(
#         #     nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=2, stride=self.s2),
#         #     nn.BatchNorm2d(64, momentum=0.01),
#         #     nn.ReLU(inplace=True)
#         # )
#         #
#         # self.convTrans9 = nn.Sequential(
#         #     nn.ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=2, stride=self.s2),
#         #     nn.BatchNorm2d(32, momentum=0.01),
#         #     nn.ReLU(inplace=True)
#         # )
#         #
#         # self.convTrans10 = nn.Sequential(
#         #     nn.ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=2, stride=self.s2),
...
#         x = self.convTrans7(x)
#         x = self.convTrans8(x)
#         x = F.interpolate(x, size=out_shape[-2:], mode='bilinear')
#         return x
#
#     def forward(self, x):
